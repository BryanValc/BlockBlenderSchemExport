...
def write_schematic(context, filepath):
    ...
    for instance in dg.object_instances:
        if instance.is_instance and instance.parent == eval_ob:
            schematic.setBlock((
            int(((((instance.object.matrix_local.translation[0])/eval_ob.scale[0])*round(eval_ob.scale[0]))/instance.object.scale[0])),
            int(((((instance.object.matrix_local.translation[2])/eval_ob.scale[0])*round(eval_ob.scale[2]))/instance.object.scale[2])),
            int(((((instance.object.matrix_local.translation[1])/eval_ob.scale[0])*round(eval_ob.scale[1]))/instance.object.scale[1]))
